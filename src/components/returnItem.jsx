        ...
        <div className="row">
          <div className="col-9">
            <div className="row card-header">
              <h5>
                <span className="text-muted ">RetId: </span>
                {returnItem.returnId}
              </h5>
              <h5>
                <span className="text-muted m-2">Retailer: </span>
                {returnItem.retailerName}
              </h5>
              <h5>
                <span className="text-muted m-2">Date: </span>
                {returnItem.returnDate.slice(0, 15)}
              </h5>
              <h5>
                <span className="text-muted m-2">SalesPerson: </span>
                {returnItem.salesPersonId}
              </h5>
              <h5>
                <span className="text-muted m-2">Amount: Rs.</span>
                {returnItem.amount}
              </h5>
            </div>
            <div className="row">
